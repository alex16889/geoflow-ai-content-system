...
### Admin Access Flow
```
1. Login at /geo_admin/ (username defaults to admin; set INITIAL_ADMIN_PASSWORD or read the generated runtime password)
...
- **Username**: `admin`
- **Password**: set `INITIAL_ADMIN_PASSWORD`, or read the generated password from `/tmp/geoflow_initial_admin_credentials.txt`
- **Encryption**: bcrypt
...
# Default account
Username: admin
Password: set INITIAL_ADMIN_PASSWORD, or read /tmp/geoflow_initial_admin_credentials.txt
```
...
- **Git Repository**: https://github.com/alex16889/geoflow-ai-content-system
